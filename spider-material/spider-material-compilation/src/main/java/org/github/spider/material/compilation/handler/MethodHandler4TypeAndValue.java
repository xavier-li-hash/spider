...
import org.github.spider.material.compilation.common.enums.JavaCGFieldRelationshipTypeEnum;
...
import org.github.spider.material.compilation.dto.branch.BranchStackEntry;
import org.github.spider.material.compilation.dto.call.MethodCallPossibleInfo;
import org.github.spider.material.compilation.dto.element.BaseElement;
import org.github.spider.material.compilation.dto.element.variable.FieldElement;
import org.github.spider.material.compilation.dto.element.variable.LocalVariableElement;
import org.github.spider.material.compilation.dto.element.variable.VariableElement;
import org.github.spider.material.compilation.dto.exception.ExceptionTargetInfo;
import org.github.spider.material.compilation.dto.exception.ThrowInfo;
import org.github.spider.material.compilation.dto.exception.ThrowInfoList;
import org.github.spider.material.compilation.dto.fieldrelationship.GetSetFieldRelationship;
import org.github.spider.material.compilation.dto.frame.*;
import org.github.spider.material.compilation.dto.instruction.InvokeInstructionPosAndCallee;
import org.github.spider.material.compilation.dto.instruction.parseresult.*;
import org.github.spider.material.compilation.dto.method.JavaCGMethodInfo;
import org.github.spider.material.compilation.dto.stack.ListAsStack;
import org.github.spider.material.compilation.dto.variabledatasource.AbstractVariableDataSource;
import org.github.spider.material.compilation.dto.variabledatasource.VariableDataSourceMethodArg;
import org.github.spider.material.compilation.dto.variabledatasource.VariableDataSourceMethodCallReturn;
...
import org.github.spider.material.compilation.util.JavaCGElementUtil;
import org.github.spider.material.compilation.util.JavaCGInstructionUtil;
...
//                "\n被调用对象与参数: " + methodCallParseResult);
    ...
    public void handleGetMethod() throws IOException {
        ...
        for (String getFieldFieldName : getFieldFieldNameSet) {
            ...
            FileUtils.write2FileWithTab(getMethodWriter, callerClassName, callerMethodName, getFieldFieldName, fieldCategory, fieldClassType, getFullMethod);
        }
    }
    ...
    public void handleSetMethod() throws IOException {
        ...
        for (String putFieldFieldName : putFieldFieldNameSet) {
            ...
            if (recordedSetMethodSet.add(callerMethodName)) {
                ...
                FileUtils.write2FileWithTab(setMethodWriter, callerClassName, callerMethodName, putFieldFieldName, fieldCategory, fieldClassType, setFullMethod);
            }
        }
    }
    ...
    private String recordFieldGenericsType(String fieldName) throws IOException {
        ...
        for (String fieldGenericsType : fieldGenericsTypeList) {
            ...
            if (!recorded) {
                // 当前字段未记录时进行记录
                FileUtils.write2FileWithTab(fieldGenericsTypeWriter,
                        callerClassName,
                        fieldName,
                        String.valueOf(seq),
