...
import org.github.spider.material.compilation.comparator.MethodArgReturnTypesComparator;
import org.github.spider.material.compilation.conf.JavaCGConfInfo;
import org.github.spider.material.compilation.dto.accessflag.JavaCGAccessFlags;
import org.github.spider.material.compilation.dto.call.MethodCall;
...
import org.github.spider.material.compilation.dto.classes.Node4ClassExtendsMethod;
...
public class ExtendsImplHandler {
    ...
    private void addExtraMethodCall(Writer methodCallWriter,
        ...
        FileUtils.write2FileWithTab(methodCallWriter, methodCall.genMethodCallContent(callerClassJarNum, calleeClassJarNum));
    }
