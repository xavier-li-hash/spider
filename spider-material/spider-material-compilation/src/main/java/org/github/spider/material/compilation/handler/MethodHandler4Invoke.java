package org.github.spider.material.compilation.handler;
...
import org.github.spider.material.compilation.common.TypeConstants;
import org.github.spider.material.compilation.common.enums.JavaCGCallTypeEnum;
import org.github.spider.material.compilation.common.enums.JavaCGCalleeObjTypeEnum;
import org.github.spider.material.compilation.common.enums.JavaCGMethodCallInfoTypeEnum;
import org.github.spider.material.compilation.common.enums.JavaCGYesNoEnum;
import org.github.spider.material.compilation.conf.JavaCGConfInfo;
import org.github.spider.material.compilation.dto.call.*;
import org.github.spider.material.compilation.dto.counter.JavaCGCounter;
import org.github.spider.material.compilation.dto.exception.*;
import org.github.spider.material.compilation.dto.field.FieldTypeAndName;
import org.github.spider.material.compilation.dto.field.StaticFieldTypeAndName;
import org.github.spider.material.compilation.dto.fieldrelationship.GetSetFieldRelationship;
import org.github.spider.material.compilation.dto.instruction.InvokeInstructionPosAndCallee;
import org.github.spider.material.compilation.dto.jar.ClassAndJarNum;
import org.github.spider.material.compilation.dto.method.JavaCGMethodInfo;
...
import org.github.spider.material.compilation.extensions.codeparser.MethodAnnotationParser;
...
import org.github.spider.material.compilation.util.*;
...
public class MethodHandler4Invoke extends AbstractMethodHandler {
    ...
    protected boolean lastStep() throws IOException {
        ...
        for (MethodCall methodCall : methodCallList.getMethodCallList()) {
            ...
            FileUtils.write2FileWithTab(methodCallWriter, methodCall.genMethodCallContent(String.valueOf(lastJarNum), calleeClassJarNum));
            if (parseMethodCallTypeValueFlag) {
                // 处理方法调用可能的信息
        ...
        if (parseMethodCallTypeValueFlag) {
            ...
            for (Integer methodReturnArgSeq : methodReturnArgSeqList) {
                FileUtils.write2FileWithTab(methodReturnArgSeqWriter, callerFullMethod, String.valueOf(methodReturnArgSeq), JavaCGYesNoEnum.NO.getStrValue());
            }
            ...
            for (Integer methodReturnPosition : methodReturnPositionList) {
                ...
                FileUtils.write2FileWithTab(methodReturnCallIdWriter, callerFullMethod, String.valueOf(methodReturnCallId), JavaCGYesNoEnum.NO.getStrValue());
            }
            ...
            for (Integer methodReturnArgSeqEQC : methodReturnArgSeqEQCList) {
                if (!methodReturnArgSeqList.contains(methodReturnArgSeqEQC)) {
                    ...
                    FileUtils.write2FileWithTab(methodReturnArgSeqWriter, callerFullMethod, String.valueOf(methodReturnArgSeqEQC), JavaCGYesNoEnum.YES.getStrValue());
                }
            }
            ...
            for (Integer methodReturnPositionEQC : methodReturnPositionEQCList) {
                if (!methodReturnPositionList.contains(methodReturnPositionEQC)) {
                    ...
                    FileUtils.write2FileWithTab(methodReturnCallIdWriter, callerFullMethod, String.valueOf(methodReturnCallIdEQC), JavaCGYesNoEnum.YES.getStrValue());
                }
            }
            ...
            if (inClinitMethod && !sfFieldInvokeInstructionMap.isEmpty()) {
                ...
                for (String staticFinalFieldName : staticFinalFieldNameList) {
                    ...
                    for (int i = 0; i < invokeInstructionPosAndCalleeList.size(); i++) {
                        ...
                        FileUtils.write2FileWithTab(staticFinalFieldMethodCallIdWriter, callerClassName, staticFinalFieldName, String.valueOf(i),
            ...
            for (GetSetFieldRelationship getSetFieldRelationship : getSetFieldRelationshipList) {
                ...
                FileUtils.write2FileWithTab(fieldRelationshipWriter,
    ...
    private void handleLineNumber(String callerFullMethod) throws IOException {
        ...
        // 记录方法起始代码行号
        FileUtils.write2FileWithTab(methodLineNumberWriter, callerFullMethod, String.valueOf(minLineNumber), String.valueOf(maxLineNumber));
    }
    ...
    private void recordExceptionInfo() throws IOException {
        ...
        for (CatchInfo catchInfo : catchInfoList) {
            ...
            for (String catchExceptionType : catchInfo.getCatchExceptionTypeList()) {
                FileUtils.write2FileWithTab(methodCatchWriter, callerFullMethod, catchExceptionType, flag, String.valueOf(tryStartLineNumber),
        ...
        for (FinallyInfo finallyInfo : finallyInfoList) {
            ...
            FileUtils.write2FileWithTab(methodFinallyWriter, callerFullMethod, tryCatchType, String.valueOf(tryCatchStartLineNumber), String.valueOf(tryCatchEndLineNumber),
    ...
    private void handleATHROW(ThrowInfoList throwInfoList) throws IOException {
        ...
        for (int i = 0; i < throwInfoList.size(); i++) {
            ...
            FileUtils.write2FileWithTab(methodThrowWriter,
                    callerFullMethod,
    ...
    private void handleINVOKEDYNAMIC(INVOKEDYNAMIC invokedynamic, JavaCGMethodInfo calleeMethodInfo, MethodCallPossibleInfo methodCallPossibleInfo) throws IOException {
        ...
        if (nextCalleeFullMethod == null) {
            ...
            FileUtils.write2FileWithTab(lambdaMethodInfoWriter, String.valueOf(methodCall.getCallId()), calleeFullMethod);
        } else {
            // 记录被调用的Lambda表达式方法信息，包含下一个被调用方法信息
            FileUtils.write2FileWithTab(lambdaMethodInfoWriter, String.valueOf(methodCall.getCallId()), calleeFullMethod, nextCalleeFullMethod);
        }
    }
    ...
    private void recordMethodCallPossibleInfo(int methodCallId, int argSeq, String argType, MethodCallPossibleList methodCallPossibleList) throws IOException {
        ...
        for (int seq = 0; seq < methodCallPossibleEntryList.size(); seq++) {
            ...
            if (staticField != null) {
                ...
                FileUtils.write2FileWithTab(methodCallStaticFieldWriter,
            ...
            if (StringUtils.isNotBlank(methodCallReturnFullMethod) && !JavaCGUtil.checkSkipClass(methodCallReturnFullMethod, javaCGConfInfo.getNeedHandlePackageSet())) {
                ...
                if (methodCallReturnInstructionPosition != null) {
                    ...
                    if (methodCallReturnCallId != methodCallId) {
                        ...
                        // 记录方法调用使用方法调用返回值
                        FileUtils.write2FileWithTab(methodCallMethodCallReturnWriter,
                                String.valueOf(methodCallId),
                                String.valueOf(argSeq),
                                String.valueOf(seq),
        ...
        FileUtils.write2FileNoLF(methodCallInfoWriter, stringBuilder.toString());
    }
    ...
    private void recordStringMethodCallPossibleInfo(StringBuilder stringBuilder, String data, int methodCallId, int argSeq, JavaCGMethodCallInfoTypeEnum type, int seq,
        ...
        String appendedData = FileUtils.appendFileColumn(
                String.valueOf(methodCallId),
                String.valueOf(argSeq),
                String.valueOf(seq),
                type.getType(),
